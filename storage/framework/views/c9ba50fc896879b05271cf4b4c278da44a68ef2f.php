    ...
    <div class="row">
        ...
        <div class="col-md-7 pe-0">
            <div class="blank-sec">
                ...
                <table class="table table-bordered mt-2 text-center p_list">
                    <thead>
                        <tr>
                            <th class="">#</th>
                            <th class="">name</th>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="mb-2">
                                    ...
                                    <input class="form-control custom-form-control dob" name="date" type="text" placeholder="Date of Birth" value="" id="date">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('master.doc_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Reflex_dn_munna1802\resources\views/doctor/patient_list.blade.php ENDPATH**/ ?>