        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('update_clinical_finding')); ?>" method="post" id="UpdateCFForm">
                    ...
                    <div class="modal-body">
                        <div class="mb-3 drug-name">
                            <input class="form-control" list="list" id="uc_f_name" placeholder="Enter New Clinical Finding" name="Ucf_name">
...
<?php echo $__env->make('admin.master.admin_doc_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Reflex_dn_munna1802\resources\views/admin/doctor/clinical_findings_list.blade.php ENDPATH**/ ?>