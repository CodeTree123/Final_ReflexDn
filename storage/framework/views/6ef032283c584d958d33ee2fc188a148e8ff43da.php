                    ...
                    $.ajax({
                        ...
                        success:function(response) {
                            ...
                            $.each(response.app_list, function( index, value ) {
                                $('#app_list_tbl').append('\
                                    <tr>\
                                        <td><img src="/../Reflex_dn_munna1802/public/uploads/patient/'+ value.image+'" alt="" width="50px" height="50px"> </td>\
                                        <td>'+value.name+'</td>\
                                        <td>'+value.mobile+'</td>\
                                        <td>'+value.time+'</td>\
                                        <td>\
...
<?php echo $__env->make('master.doc_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Reflex_dn_munna1802\resources\views/doctor/appointment.blade.php ENDPATH**/ ?>