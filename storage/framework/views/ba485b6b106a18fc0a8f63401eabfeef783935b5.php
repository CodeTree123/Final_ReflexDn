                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="mb-2">
                                ...
                                <input type="name" name="name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Name" value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                        ...
                        <div class="col-4">
                            <div class="mb-2">
                                ...
                                <!-- <br> class="msform"-->
                                <input class="form-control custom-form-control dob" name="date" type="date" value="<?php echo e($pf->date); ?>" max="<?php echo e(date('Y-m-d')); ?>">
                                <span class="text-danger"><?php $__errorArgs = ['date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('master.doc_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\new_project\Final_reflexdn\resources\views/doctor/doctor.blade.php ENDPATH**/ ?>