    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="d-flex justify-content-around p-0">
                <button class="btn crud-btns Investigation_editbtn <?php echo e("Invest_".$investigation_list->id); ?>" value="<?php echo e($investigation_list->id); ?>">
...
<?php echo $__env->make('admin.master.admin_doc_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Reflex_dn_munna0902\resources\views/admin/doctor/investigation_list.blade.php ENDPATH**/ ?>