...
unset($__errorArgs, $__bag); ?></span>
                <div class="col-md-5 blue-grey-border py-4">
                    ...
                    <form action="<?php echo e(route('doctor')); ?>" method="GET">
                        ...
                        <div class="d-flex my-auto">
                            ...
                            <button type="submit" class="btn btn-outline-blue-grey" <?php echo e(auth()->user()->setting_alert == 1 ? 'disabled':''); ?>>Search</button>
                        </div>
                    </form>
                </div>
                <div class="col-md-5 blue-grey-border ">
                    ...
                    <div class="new-gen-pat">
                        <!--  a tag trigger modal -->
                        <button class="btn btn-outline-blue-grey text-white my-3" data-bs-toggle="modal" data-bs-target="#patitentAdd" <?php echo e(auth()->user()->setting_alert == 1 ? 'disabled':''); ?>>New Patient Registration
                        </button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('patient_info',[$doctor_info->id])); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                        <input type="number" name="mobile" class="form-control" placeholder="Mobile No" value="<?php echo e(old('mobile')); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="mb-3">
                                <input type="name" name="name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Name" value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                        ...
                        <div class="col-4">
                            <div class="mb-3">
                                <input class="form-control dob" name="date" type="text" placeholder="Date of Birth(Y-M-D / D-M-Y)" value="<?php echo e(old('date')); ?>">
                        ...
                        <div class="col">
                            <div class="mb-3">
                                <select class="form-select" name="gender" aria-label="Gender">
                                    ...
                                    <option value="Other" <?php echo e(old('gender') == "Other" ? 'selected':''); ?>>Others</option>
                                </select>
...
unset($__errorArgs, $__bag); ?></span>
                    ...
                    <div class="mb-3">
                        <input type="address" class="form-control" name="address" placeholder="Address" value="<?php echo e(old('address')); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                    ...
                    <div class="">
                        <input type="email" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Email address" value="<?php echo e(old('email')); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                    ...
                    <div class="mt-2">
                        <label for="formFile" name="image" class="form-label text-dark">Drop your image</label>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-2">
                                ...
                                <input type="number" name="age" class="form-control custom-form-control age" id=" " aria-describedby="emailHelp" placeholder="Age" value="<?php echo e($pf->age); ?>" readonly>
                                <span class="text-danger"><?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('master.doc_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Reflex_dn_munna1802\resources\views/doctor/doctor.blade.php ENDPATH**/ ?>