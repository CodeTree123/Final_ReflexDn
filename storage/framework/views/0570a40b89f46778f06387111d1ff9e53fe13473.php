                        ...
                        <div class="container-fluid">
                            <div class="collapse navbar-collapse" id="navbarNav">
                                <ul class="navbar-nav fs-5 pe-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-bg-blue-grey" href="<?php echo e(route('shop_panel')); ?>">Shop Panel</a>
                                    </li>
                                    <!-- <li class="nav-item">
...
<?php /**PATH C:\xampp\htdocs\Reflex_dn_munna0902\resources\views/admin/include/adminheader.blade.php ENDPATH**/ ?>