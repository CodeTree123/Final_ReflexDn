        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('update_chife_complaint')); ?>" method="post" id="UpdateCCForm">
                    ...
                    <div class="modal-body">
                        <div class="mb-3 drug-name">
                            <input class="form-control" list="list" id="c_c_name" placeholder="Enter New Chief Complaint" name="Ucc_name" value="<?php echo e(old('Ucc_name')); ?>">
...
<?php echo $__env->make('admin.master.admin_doc_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Reflex_dn_munna0902\resources\views/admin/doctor/chief_complaint_list.blade.php ENDPATH**/ ?>