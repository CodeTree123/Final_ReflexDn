                                ...
                                <h6 class="p-2 d-flex justify-content-between bg-blue-grey custom-border-radius">
                                    ...
                                    <div class="treatment-box p-2">
                                        ...
                                        <select class="form-select" aria-label="Default select example" id="t_status" name="t_status">
                                            <option <?php echo e(old('t_status',$treatment_info->status) == '0' ? 'selected' : ''); ?> value="0">Not
                                                Done
                                            </option>
                                            <option <?php echo e(old('t_status',$treatment_info->status) == '1' ? 'selected' : ''); ?> value="1">
                                                Progress
                                            </option>
                                            <option <?php echo e(old('t_status',$treatment_info->status) == '2' ? 'selected' : ''); ?> value="2">
                                                Done
                                            </option>
                                        </select>
                        ...
                        <div class="treatment-box p-2">
                            <div class="p-2">
                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="12" name="steps"
                                          placeholder="Enter OT Notes"><?php echo e(old('steps')); ?></textarea>
...
<?php echo $__env->make('master.doc_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Reflex_dn_munna1802\resources\views/doctor/treatmentplans.blade.php ENDPATH**/ ?>