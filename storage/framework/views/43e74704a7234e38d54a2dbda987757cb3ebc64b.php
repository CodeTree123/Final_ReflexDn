...
unset($__errorArgs, $__bag); ?></span>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" name="mCollege" class="form-control mb-2 " id="mCollege" placeholder="Enter  Medical College" value="<?php echo e($doctor_info->doctor->mCollege); ?>">
...
<?php echo $__env->make('master.doc_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Reflex_dn_munna1502\resources\views/doctor/profile_edit.blade.php ENDPATH**/ ?>