                    ...
                    <form action="<?php echo e(route('treatment_payment')); ?>" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" aria-label="Default select example" name="t_plan_id" id="t_plan_id">
                                ...
                                <option value="<?php echo e($treatment_invoice_info -> id); ?>"><?php echo e($treatment_invoice_info -> treatment_plans); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="mb-3">
...
<?php echo $__env->make('master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Reflex_dn_munna\resources\views/invoice.blade.php ENDPATH**/ ?>