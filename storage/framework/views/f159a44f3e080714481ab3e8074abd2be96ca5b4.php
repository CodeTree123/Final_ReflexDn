                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo e(route('subscription_status',[$subscription_list->id])); ?>" class="btn btn-sm btn-success my-0">Paid</a>
                                <?php else: ?>
                                <a href="<?php echo e(route('subscription_status',[$subscription_list->id])); ?>" class="btn btn-sm btn-danger my-0">Unpaid</a>
                                <?php endif; ?>
                            </td>
                            <td class="d-flex justify-content-around">
                                ...
                                <button class="btn crud-btns delete-subscribtion" href="#" value="<?php echo e($subscription_list->id); ?>">
                                    <i class="fa-solid fa-trash"></i>
                                </button>
                            </td>
                        </tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo e(route('notice_status',[$notice->id])); ?>" class="btn btn-sm btn-danger my-0">Inactive</a>
                                <?php else: ?>
                                <a href="<?php echo e(route('notice_status',[$notice->id])); ?>" class="btn btn-sm btn-success my-0">Active</a>
                                <?php endif; ?>
                            </td>
                            <td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('update_doctor')); ?>" method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-floating ">
                            <input type="name" name="name" id="d_name" class="form-control custom-form-control mb-2" placeholder="name@example.com" value="<?php echo e(old('name')); ?>">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo e(route('redeem_status',[$redeem->id])); ?>" class="btn btn-sm btn-danger my-0">Inactive</a>
                                <?php else: ?>
                                <a href="<?php echo e(route('redeem_status',[$redeem->id])); ?>" class="btn btn-sm btn-success my-0">Active</a>
                                <?php endif; ?>
                            </td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('master.admin_master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Reflex_dn_munna\resources\views/admin_page.blade.php ENDPATH**/ ?>