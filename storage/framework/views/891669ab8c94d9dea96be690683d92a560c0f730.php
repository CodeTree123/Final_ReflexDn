    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <?php else: ?>
                <a href="<?php echo e(route('supplier_status',[$shop->id])); ?>" class="btn btn-sm btn-success my-0">Unblock</a>
                <?php endif; ?>
            </td>
...
unset($__errorArgs, $__bag); ?></span>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="password" class="form-control" id="exampleFormControlInput1" name="s_password">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.master.admin_shop_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Reflex_dn_munna0902\resources\views/admin/shop/supplier_list.blade.php ENDPATH**/ ?>