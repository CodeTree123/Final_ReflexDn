        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('admin_update_tp')); ?>" method="post" id="UpdateTPForm">
                    ...
                    <div class="modal-body">
                        <div class="mb-3 drug-name">
                            <input class="form-control" list="list" id="Ut_p_name" placeholder="Enter New Treatment Plan" name="Utp_name">
...
<?php echo $__env->make('admin.master.admin_doc_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Reflex_dn_munna1802\resources\views/admin/doctor/treatment_plans_list.blade.php ENDPATH**/ ?>