            ...
            <div class="w-100 ms-2">
                ...
                <div class="collapse navbar-collapse me-2" id="navbarSupportedContent">
                    <ul class="navbar-nav flex-column mb-2 mb-lg-0 w-100">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white text-center bg-dark my-2" href="<?php echo e(route('shop_admin_product_list')); ?>">Order List</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white text-center bg-dark my-2" href="<?php echo e(route('shop_admin_product_list')); ?>">Confirmed Order List</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Reflex_dn_munna0902\resources\views/admin/include/admin_shop_manu.blade.php ENDPATH**/ ?>