    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <button class="btn btn-sm btn-success my-0 rounded-pill">Paid</button>
                <?php else: ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-around  p-0">
                                ...
                                <button class="btn crud-btns delete-redeem" data-name="<?php echo e($redeem->redeem_code); ?>" value="<?php echo e($redeem->id); ?>">
                                    <i class="fa-solid fa-trash"></i>
                                </button>
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('delete_redeem')); ?>" method="POST">
                    ...
                    <div class="mb-3 text-center">
                        <h5 class="text-danger">Are You Sure to Delete <span id="redeem_name"></span> Redeem Code?</h5>
                    </div>
...
<?php echo $__env->make('admin.master.admin_doc_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Reflex_dn_munna0902\resources\views/admin/doctor/subscription_list.blade.php ENDPATH**/ ?>