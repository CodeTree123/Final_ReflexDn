...
<main class="bg-dark">
                ...
                <div class="d-flex justify-content-between">
                    <div class="mb-3">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>
                                <p class="deg2">{{$doctor_info->doctor->bDegree}}</p>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @else
                        <img src="{{asset ('public/uploads/Barcode/'.$doctor_info->doctor->bar_image)}}" alt="Qr" class="img-fluid" width="100" height="100">
                        @endif
                    </div>
                    <div class="date w-25">
                    ...
                    <table class="table table-sm table-borderless">
                        ...
                        <tr class="">
                            ...
                            <td class=" "><span class="title">Next Appointment :
                                    @if($appointment != null)
                                    {{\Carbon\Carbon::parse($appointment->date)->format('d/m/Y')}}</span>
                                @endif
                            </td>
                        </tr>
                    </table>
    ...
    <div>
        ...
        <button type="button" class="btn btn-primary submitPrescription-btn px-2 submitPrescription d-print-none" value="{{$patient->id}}">Submit <br> Prescription
        </button>
    </div>
</main>
<!-- ========= M O D A L ========= -->
