                        ...
                        <div class="tab-pane fade show active" id="barcode-tab-pane" role="tabpanel" aria-labelledby="barcode-tab" tabindex="0">
                            ...
                            <table class="table table-bordered mt-4 text-center align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{asset('public/uploads/Barcode/'.$doctor_info->doctor->bar_image)}}" alt="Barcode" width="200" class="image_view_sami" style="cursor: pointer">
            ...
            <div class="modal-body">
                <form action="{{route('update_barcode')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <img src="{{asset('public/uploads/Barcode/'.$doctor_info->doctor->bar_image)}}" alt="Barcode" width="200">
                    </div>
